...
Ext.define('Ext.plugin.GMap.Tracker', {
    ...
    constructor : function(config) {
        ...
        this.onError = Ext.Function.bind(this.onError, this);
        this.onPosition = Ext.Function.bind(this.onPosition, this);
        this.updateLocation = Ext.Function.bind(this.updateLocation, this);
    ...
    init : function(host){
       if (host && typeof host.renderMap == 'function') {
            ...
            Ext.apply(host, {
                suspendUpdates : Ext.Function.bind(this.suspendUpdates, this),
                resumeUpdates  : Ext.Function.bind(this.resumeUpdates, this),
                setHighAccuracy  : Ext.Function.bind(this.setHighAccuracy, this)
            });
